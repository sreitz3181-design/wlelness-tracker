...
export async function POST(request) {
  ...
  const prompt = `You are helping someone reflect each day on their week's church sermon and on God's love.

${sermonNotes ? `This week's sermon notes:\n"""${sermonNotes}"""` : 'No sermon notes were provided for this week — write a reflection question about walking with God generally.'}

Today's scripture reference for a reminder of God's love: ${reference} (theme: ${theme}).

Write two things:
1. A single, specific reflection question (one sentence) drawing on the sermon notes above, meant to prompt genuine personal reflection — not generic ("What did the sermon mean to you?" is too generic; something concrete tied to what was actually said is better).
